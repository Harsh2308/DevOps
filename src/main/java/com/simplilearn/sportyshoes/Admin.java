...
public class Admin {
	...
	public String toString() {
		return "Admin [ad_fname=" + ad_fname + ", ad_lname=" + ad_lname + ", ad_phone=" + ad_phone + ", ad_mail="
				+ ad_mail + ", ad_dob=" + ad_dob + ", ad_pass=" + ad_pass + ", ad_con=" + ad_con + ", ad_state="
				+ ad_state + ", ad_dist=" + ad_dist + ", ad_taluka=" + ad_taluka + ", ad_pin=" + ad_pin + ", ad_gen="
				+ ad_gen + ", log_date=" + log_date + "]";
	}

	public Admin(int ad_id, String ad_fname, String ad_lname, String ad_phone, String ad_mail, String ad_dob,
			String ad_pass, String ad_con, String ad_state, String ad_dist, String ad_taluka, String ad_pin,
			String ad_gen, String log_date) {
		super();
		this.ad_id = ad_id;
